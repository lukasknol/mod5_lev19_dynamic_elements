const animalSpotted = event => {
    const spotAnimal = event.target.textContent;
    const listItem = document.createElement("li");
    listItem.appendChild(document.createTextNode(spotAnimal));
...
const removeAll = () => {
    const spotAnimalsList = document.getElementById("spotted-animals-list");
    spotAnimalsList.innerHTML = "";
};
